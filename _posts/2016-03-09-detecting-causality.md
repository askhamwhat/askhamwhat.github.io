...
<img src="/assets/post_resources/images/correlation-mirage.png" 
     alt="correlation mirage" width="100%" />

The code used to generate this plot can be found
[here](/assets/post_resources/code/fig1code.m). The phenomena
...
1. **An example with bidirectional causality**. We consider
   ...
   <img src="/assets/post_resources/images/bidirectional_coupling.png" 
   ...
   image can be found [here](/assets/post_resources/code/bidir_system.m).
...
2. **An example with unidirectional causality**. Now we consider
   ...
   <img src="/assets/post_resources/images/asymmetric_coupling.png" 
   ...
   [here](/assets/post_resources/code/asym_system.m).
...
[here](/assets/post_resources/data/veilleux.dat) and 
a version which can be loaded easily into MatLab
[here](/assets/post_resources/data/vel-11a.dat) (this
...
<img src="/assets/post_resources/images/didinium_paramecium.png" 
   	  alt="bidirectional coupling" width="100%" />
...
[here](/assets/post_resources/code/didinium_paramecium.m).
